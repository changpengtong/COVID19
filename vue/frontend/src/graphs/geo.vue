...
<div>
    ...
    <el-tab-pane label="map">
        ...
        <span style="font-weight:bold;font-size:x-large">map</span>
        <el-tooltip class="item" effect="dark" content="Geo map for the papers" placement="top-start">
                <i class="el-icon-question"></i>
        </el-tooltip>

        <div class="graph" id="geoChart"></div>
...
// import $axios from './../util/axios'
    ...
    export default {
        ...
        methods: {
            ...
            draw_geo() {
                let chart = document.getElementById("geoChart");
