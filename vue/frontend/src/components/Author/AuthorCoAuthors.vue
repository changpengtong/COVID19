<template>
    ...
    <!-- head+button -->
        <div class="head">
            <span class="title-left" style="margin-right: 11em">Co-authors</span><el-button type="text" @click="dialogTableVisible = true" ><span class="title-right" style="text-align: right">View All</span></el-button>
        </div>
        ...
        methods: {
            get_data() {
                ...
                for(let i=0;i<this.d.length;i++) {
                    t.push({'name':this.d[i]["FullName"],'work':this.d[i]["Affiliation"]})
                }
                this.coauthors = t
